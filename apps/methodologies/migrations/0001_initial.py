...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('projects', '0009_projectapitoken_date_valid'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('task', 'project', 'asset_service'), ('task', 'project', 'asset_host'), ('task', 'project', 'asset_webrequest'), ('task', 'project', 'asset_webapp')},
            },
        ),
    ]
